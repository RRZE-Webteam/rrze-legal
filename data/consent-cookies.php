...
$data = [
    ...
    'items' => [
        ...
        'facebook' => [
            ...
            'prioritize' => false,
            'async_opt_out_code' => false,
            'opt_in_js' => '<script>if(typeof window.RRZELegal === "object") { window.RRZELegal.unblockContentId("facebook"); }</script>',
            'opt_out_js' => '',
            'fallback_js' => '',
            'position' => 1,
            'status' => false,
        ...
        'googlemaps' => [
            ...
            'prioritize' => false,
            'async_opt_out_code' => false,
            'opt_in_js' => '<script>if(typeof window.RRZELegal === "object") { window.RRZELegal.unblockContentId("googlemaps"); }</script>',
            'opt_out_js' => '',
            'fallback_js' => '',
            'position' => 2,
            'status' => false,
        ...
        'openstreetmap' => [
            'id' => 'openstreetmap',
            'cookie_name' => '_osm_location, _osm_session, _osm_totp_token, _osm_welcome, _pk_id., _pk_ref., _pk_ses., qos_token',
            'category' => 'external_media',
            'name' => __('OpenStreetMap', 'rrze-legal'),
            'provider' => __('Openstreetmap Foundation, St John’s Innovation Centre, Cowley Road, Cambridge CB4 0WS, United Kingdom', 'rrze-legal'),
            'purpose' => __('Used to unblock OpenStreetMap content.', 'rrze-legal'),
            'privacy_policy_url' => 'https://wiki.osmfoundation.org/wiki/Privacy_Policy',
            'hosts' => '.openstreetmap.org',
            'cookie_expiry' => __('1-10 Years', 'rrze-legal'),
            'enqueued_script_handles' => '',
            'block_enqueued_script' => false,
            'prioritize' => false,
            'async_opt_out_code' => false,
            'opt_in_js' => '<script>if(typeof window.RRZELegal === "object") { window.RRZELegal.unblockContentId("openstreetmap"); }</script>',
            'opt_out_js' => '',
            'fallback_js' => '',
            'position' => 4,
            'status' => false,
